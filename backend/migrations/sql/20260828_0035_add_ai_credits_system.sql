...
-- Backfill real per-plan values for existing paying subscribers so this
-- deploy doesn't silently cut off their AI chat access / OCR / page
-- limits until an admin manually re-enters them.
